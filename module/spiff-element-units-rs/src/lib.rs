...
//
// get the cached element unit required to start the process
//
pub fn cached_element_unit_for_process(
    cache_dir: &str,
    cache_key: &str,
    _process_id: &str,
...
//
// get the cached element unit required to resume a process at a given element
//
pub fn cached_element_unit_for_element(
    cache_dir: &str,
    cache_key: &str,
    _process_id: &str,
    _element_id: &str,
